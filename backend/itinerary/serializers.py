...
class BulkCreateItinerarySerializer(serializers.Serializer):
    """Serializer for bulk creating multiple itineraries"""
    items = serializers.ListField(
        child=serializers.DictField(
            child=serializers.CharField(),
        ),
        required=True,
        help_text="List of itinerary objects with 'title' and 'description' fields"
    )
    ...
    def create(self, validated_data):
        """Create multiple itineraries from the validated data"""
        ...
        for idx, item_data in enumerate(items):
            try:
                ...
                created_items.append(ItinerarySerializer(itinerary).data)
